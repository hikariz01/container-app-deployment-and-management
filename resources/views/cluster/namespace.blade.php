...
@section('content')
    ...
    <div id="data" style="display: none">{{\Symfony\Component\Yaml\Yaml::dump($namespace->toArray(), 512, 2)}}</div>
...
@section('js')
    ...
    <script>
        ...
        let kind = '{{$namespace->getKind()}}';
        let namespace = '{{$namespace->getNamespace()}}';
        let name = '{{$namespace->getName()}}';
