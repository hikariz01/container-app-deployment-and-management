...
@section('content')
    ...
    <div id="data" style="display: none">{{\Symfony\Component\Yaml\Yaml::dump($storageclass->toArray(), 512, 2)}}</div>
...
@section('js')
    ...
    <script>
        ...
        let kind = '{{$storageclass->getKind()}}';
        let namespace = '{{$storageclass->getNamespace()}}';
        let name = '{{$storageclass->getName()}}';
