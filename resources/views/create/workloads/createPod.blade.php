    ...
    <div style="width: 80vw; height: calc(100vh - 90px); margin: 30px auto;">
        <form action="{{ route('result') }}" method="POST" onsubmit="podNameCheck()">
            <div class="form-group row">
                ...
                <div class="col-6 mt-1" id="podLabel">
                    <div class="row">
                        <div class="col-10">
                ...
                <div class="col-12 my-2 advancedOption" style="display: none">
                    <label for="annotation" class="col-form-label">Description</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <label for="containerImage" class="col-form-label">Container Image<sup>*</sup></label>
